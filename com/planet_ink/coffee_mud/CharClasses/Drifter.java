...
public class Drifter extends Thief
{
	@Override
	public String ID()
	{
	...
	private final static String localizedStaticName = CMLib.lang().L("Drifter");
	...
	{
		return CharClass.WEAPONS_DRIFTER;
	}
